...
<body id="page-top" class="bg-primary">
    ...
    <a href="admin.php" class="btn-back" style="margin-right: 650px;" style=""><img class="retour" src="../assets/img/fleche.png" style="height:30px;margin-top:-1px; padding-right:5px;"> Retour</a>
        ...
        <div class="row">
            ...
            <div class="col">
            <form action="" method="post">
                    <label for="message" class="mb-2">Répondre :</label>
                    <textarea id="message" class="form-control" name="message" placeholder="Entrez votre réponse..." style="width:450px;height:292px;color: black;" ></textarea><br>
                    <input type="submit" name="reponse" class="btn mt-3 mb-3 btn-primary border border-white" value="Envoyer la réponse">
                </form>
            </div>
        </div>
    </header>
